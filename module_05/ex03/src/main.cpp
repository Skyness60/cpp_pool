...
int main() {
    ...
    while (isRunning)
    {
        ...
        std::cout << "\033[1;36m" << "║└──────────────┴───────────────┘║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║                                ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║          Status Intern :       ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║┌──────────────┬───────────────┐║" << std::endl;
        std::cout << "\033[1;36m" << "║|" << std::setw(9) << "Intern" << std::setw(6) << "|" << std::setw(10) << "Check" << "     |║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║├──────────────┼───────────────┤║" << std::endl;
        for (int i = 0; i < countI; i++) {
            std::cout << "\033[1;36m" << "║|" << std::setw(10) << truncate(dataI[i].first) << std::setw(5) << "|" << std::setw(8);
            if (dataI[i].second)
                std::cout << "\033[1;36m" << std::setw(8) << "✅"  << std::setw(11) << "|║" << std::endl;
            else
                std::cout << "\033[1;36m" << std::setw(8)  << "❌" << std::setw(11) << "|║" << std::endl;
        ...
        std::cout << "\033[1;36m" << "║ \033[1;32m2\033[1;36m    - Create a Intern         ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║ \033[1;33m3\033[1;36m    - Create a Form           ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║ \033[1;34m4\033[1;36m    - Sign a Form             ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║ \033[1;31m5\033[1;36m    - Exec a Form             ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "║ \033[1;31m6\033[1;36m    - Exit                    ║" << "\033[0m" << std::endl;
        std::cout << "\033[1;36m" << "╚════════════════════════════════╝" << "\033[0m" << std::endl;
		...
		else if (input == "2")
		{
			...
			while (true)
			{
				if (countI >= 1)
				{
					std::cout << BOLD_RED << "You have reached the maximum number of interns" << std::endl;
					break ;
				}
				try {
					interns[countI] = new Intern();
					if (!interns[countI])
					{
						std::cout << BOLD_RED << "Error creating intern" << RESET << std::endl;
						isRunning = false;
						break;
					}
					dataI[countI].first = "Intern";
					dataI[countI].second = true;
					countI++;
					clearScreen();
					break;
				}
				catch (std::exception &e) {
					std::cerr << BOLD_RED << "Finally Intern is not created because : " << RESET << std::endl;
					std::cerr << BOLD_RED << e.what() << RESET << std::endl;
				}
			}
		}
		else if (input == "3")
		{
			while (true)
			{
				...
				{
					std::cout << BOLD_RED << "You need to create at least one bureaucrat and one intern" << RESET << std::endl;
					continue ;
				}
				if (countF >= 100)
				{
				...
				std::cout << BOLD_BLUE << "Enter the type of the Form (robotomy request, shrubbery creation, presidential pardon): " << BOLD_WHITE;
				...
				try {
					if (type == "shrubbery creation")
						forms[countF] = interns[0]->makeForm(type, target);
					...
					{
						forms[countF] = interns[0]->makeForm(type, target);
						std::cout << BOLD_RED << "Form type does not exist" << RESET << std::endl;
						forms[countF] = NULL;
						continue;
					}
					if (!forms[countF])
